...
class Maneuver:
  def __init__(self, title, duration, **kwargs):
    ...
    self.model_velocity_x_values = kwargs.get("model_velocity_x_values", None)
  ...
  def evaluate(self):
    plant = Plant(
      ...
      longitudinal_stack=self.longitudinal_stack,
    )
    ...
    while plant.current_time < self.duration:
      ...
      model_velocity_x = (
        None if self.model_velocity_x_values is None else np.interp(plant.current_time, self.breakpoints, self.model_velocity_x_values)
      )
      ...
      log = plant.step(speed_lead, prob_lead, cruise, pitch, prob_throttle, lead_y_rel,
                       ...
                       model_position_x=model_position_x, model_velocity_x=model_velocity_x)
