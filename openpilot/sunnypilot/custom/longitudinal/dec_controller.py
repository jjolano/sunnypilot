"""Canonical implementation of the Dynamic Experimental Controller parity shim.

This module houses the DEC behavior preserved from the original extension module.
The active ``sunnypilot/selfdrive/controls/lib/dec/dec.py`` is a compatibility facade
that re-exports ``DynamicExperimentalController`` so existing imports keep working.
"""
...
class DynamicExperimentalController:
  def __init__(self, CP, mpc, params=None):
    self._CP = CP
    self._mpc = mpc
