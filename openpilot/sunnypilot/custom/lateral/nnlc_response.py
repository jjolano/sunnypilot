"""NNLC response path — canonical home for the neural-network lateral-control logic.

This module is the Phase-2 extraction of ``sunnypilot/selfdrive/controls/lib/nnlc/nnlc.py``.
The original file is now a compatibility facade that re-exports ``NeuralNetworkLateralControl``.
