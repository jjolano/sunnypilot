"""Legacy torque-extension wiring — canonical home for the combined NNLC/override extension.

This module is the Phase-2 extraction of ``sunnypilot/selfdrive/controls/lib/latcontrol_torque_ext.py``.
The original file is now a compatibility facade that re-exports ``LatControlTorqueExt``.
No behavior or numeric changes were made.
"""
from openpilot.sunnypilot.custom.lateral.nnlc_response import NeuralNetworkLateralControl
