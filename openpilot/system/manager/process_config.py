...
procs = [
  ...
  PythonProcess("webjoystick", "openpilot.tools.bodyteleop.web", notcar),
  PythonProcess("joystick", "openpilot.tools.joystick.joystick_control", and_(joystick, iscar)),

  # sunnylink <3
  DaemonProcess("manage_sunnylinkd", "openpilot.sunnypilot.sunnylink.athena.manage_sunnylinkd", "SunnylinkdPid"),
  # tailscale
  DaemonProcess("manage_tailscaled", "openpilot.sunnypilot.system.tailscale.manage_tailscaled", "TailscaledPid"),
