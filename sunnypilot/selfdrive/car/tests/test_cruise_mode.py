...
class TestCruiseHelper:
  ...
  def test_gap_adjust_cruise_long_press_consumed(self) -> None:
    for pressed in (True, False):
      for experimental_mode in (True, False):
        ...
        # long hold is consumed by speed-limit auto cruise, not Experimental Mode
  ...
  def test_gap_adjust_cruise_short_press_not_consumed(self) -> None:
    for pressed in (True, False):
      for experimental_mode in (True, False):
        self.reset()
        self.cruise_helper._experimental_mode = experimental_mode
