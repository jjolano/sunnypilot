"""NNLC helper utilities — canonical home for model-path lookup helpers.

This module is the Phase-2 extraction of ``sunnypilot/selfdrive/controls/lib/nnlc/helpers.py``.
The original file is now a compatibility facade that re-exports these symbols.
