"""NNLC model adapter — canonical home for the NN torque model wrapper.

This module is the Phase-2 extraction of ``sunnypilot/selfdrive/controls/lib/nnlc/model.py``.
