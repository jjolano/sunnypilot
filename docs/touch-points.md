...
| `selfdrive/ui/sunnypilot/layouts/settings/settings.py` | Mount consolidated schema-driven panels: `Driving` (steering+cruise) + `Interface` (visuals+display); sidebar collapses those 4 entries → 2 |
