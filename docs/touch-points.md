...
| File | Why |
|---|---|
| `common/params_keys.h` | Tailscale param keys (12) + custom long/lat opt-in params (4) + speed-aware torque params (2) + schema-driven steering A/B flag (1) |
...
| `selfdrive/ui/sunnypilot/layouts/settings/settings.py` | Flag-gated steering panel factory (`SettingsSchemaDrivenSteering`) for the schema-driven A/B (1-line swap + factory) |
